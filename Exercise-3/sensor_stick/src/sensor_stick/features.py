...
def compute_normal_histograms(normal_cloud):
    ...
    # print("max norm_x_vals: ", np.max(norm_x_vals))
    # print("min norm_x_vals: ", np.min(norm_x_vals))
    # print("norm_y_vals: ", np.max(norm_y_vals))
    # print("norm_y_vals: ", np.min(norm_y_vals))
